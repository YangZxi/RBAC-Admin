...
import cn.xiaosm.yadmin.basic.mapper.provider.MenuProvider;
...
public interface MenuMapper extends BaseMapper<Menu> {
    ...
    @Results(id = "menuMap", value = {
            ...
            @Result(property = "children", column = "id",
                    many = @Many(select = "cn.xiaosm.yadmin.basic.mapper.MenuMapper.findAllByParentId"))
    })
    List<Menu> findAll();
    ...
    @Results(id = "menuMapByRoleId", value = {
            ...
            @Result(property = "children", column = "{roleId = r.id, parentId = id}",
                many = @Many(select = "cn.xiaosm.yadmin.basic.mapper.MenuMapper.selectAllByRoleIdAndParentId",
