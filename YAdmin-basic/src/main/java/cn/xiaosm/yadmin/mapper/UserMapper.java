package cn.xiaosm.yadmin.mapper;

import cn.xiaosm.yadmin.entity.User;
import cn.xiaosm.yadmin.entity.UserLoginTrack;
import cn.xiaosm.yadmin.entity.dto.UserDTO;
...
public interface UserMapper extends BaseMapper<User> {
    ...
    @Results(id = "userRoleMap", value = {
            ...
            @Result(property = "roles", column = "id",
                    many = @Many(select = "cn.xiaosm.yadmin.mapper.RoleMapper.selectIdAndNameByUserId")),
            // 查询用户登录足迹
            @Result(property = "userLoginTracks", column = "id",
                    many = @Many(select = "cn.xiaosm.yadmin.mapper.UserMapper.selectUserTrackByUserId"))
    })
